    ...
    <div className="min-h-full bg-primary">
      ...
      <form onSubmit={handleSubmit} className="max-w-3xl mx-auto px-6 py-10">
        ...
        <section className="flex flex-col gap-6">
          <header>
            <h2 className="text-base font-semibold text-primary">The problem</h2>
            <p className="text-sm text-secondary mt-0.5">Tell us what hurts and how it shows up today.</p>
          </header>
        ...
        <hr className="my-10 border-weak" />

        {/* Section 2: Impact */}
        <section className="flex flex-col gap-6">
          <header>
            <h2 className="text-base font-semibold text-primary">Impact</h2>
            <p className="text-sm text-secondary mt-0.5">Who&apos;s affected, and what success looks like.</p>
          </header>
        ...
        <section className="flex flex-col gap-6">
          <header>
            <h2 className="text-base font-semibold text-primary">About you</h2>
            <p className="text-sm text-secondary mt-0.5">So we know who to reach out to.</p>
          </header>
        ...
        <button
          ...
          className="mt-10 self-start inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 dark:disabled:bg-gray-700 disabled:cursor-not-allowed text-white font-semibold px-6 py-3 rounded-lg transition-colors"
        >
